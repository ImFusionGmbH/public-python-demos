...
- `imfusion-sdk` is a standalone Python package that provides bindings to a subset of the powerful ImFusion C++ SDK. You can obtain it directly from PyPI using `pip` and it can be used in without any other ImFusion software through a regular Python interpreter.
  ...
  - Beyond the base capabilites of the `imfusion-sdk` package, our ["Professional" SDK offering](https://imfusion.com/shop/imfusion-sdk/) also includes specialized, modality-specific modules:
    ...
    - [imfusion-sdk-computed_tomography](https://github.com/ImFusionGmbH/public-python-demos/tree/master/imfusion-sdk-vision) contains demo notebooks for the `imfusion.vision` submodule.
